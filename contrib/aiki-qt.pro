...
RESOURCES += src/qt/aiki.qrc src/qt/aiki_locale.qrc

TRANSLATIONS += src/qt/locale/aiki_bg.ts \
                src/qt/locale/aiki_de.ts \
                src/qt/locale/aiki_en.ts \
                src/qt/locale/aiki_es.ts \
                src/qt/locale/aiki_fi.ts \
                src/qt/locale/aiki_fr.ts \
                src/qt/locale/aiki_it.ts \
                src/qt/locale/aiki_ja.ts \
                src/qt/locale/aiki_pl.ts \
                src/qt/locale/aiki_pt.ts \
                src/qt/locale/aiki_ru.ts \
                src/qt/locale/aiki_sk.ts \
                src/qt/locale/aiki_sv.ts \
                src/qt/locale/aiki_vi.ts \
                src/qt/locale/aiki_zh_CN.ts \
                src/qt/locale/aiki_zh_TW.ts
