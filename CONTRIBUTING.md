...
The Aiki project operates an open contributor model where anyone is
...
The following applies to code changes to the Aiki project, and is not to be
confused with overall AIKI Network Protocol consensus changes.

Whether a pull request is merged into Aiki rests with the project merge
...
Patches that change AIKI consensus rules are considerably more involved than
...
Where a patch set proposes to change the AIKI consensus, it must have been
...
The project leader is the release manager for each Aiki release.
