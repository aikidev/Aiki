...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Aiki features */
        {"aiki", "masternode", &masternode, true, true, false},
        {"aiki", "listmasternodes", &listmasternodes, true, true, false},
        {"aiki", "getmasternodecount", &getmasternodecount, true, true, false},
        {"aiki", "masternodeconnect", &masternodeconnect, true, true, false},
        {"aiki", "masternodecurrent", &masternodecurrent, true, true, false},
        {"aiki", "masternodedebug", &masternodedebug, true, true, false},
        {"aiki", "startmasternode", &startmasternode, true, true, false},
        {"aiki", "createmasternodekey", &createmasternodekey, true, true, false},
        {"aiki", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"aiki", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"aiki", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"aiki", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"aiki", "getmasternodescores", &getmasternodescores, true, true, false},
        {"aiki", "mnbudget", &mnbudget, true, true, false},
        {"aiki", "preparebudget", &preparebudget, true, true, false},
        {"aiki", "submitbudget", &submitbudget, true, true, false},
        {"aiki", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"aiki", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"aiki", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"aiki", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"aiki", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"aiki", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"aiki", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"aiki", "checkbudgets", &checkbudgets, true, true, false},
        {"aiki", "mnsync", &mnsync, true, true, false},
        {"aiki", "spork", &spork, true, true, false},
        {"aiki", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"aiki", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use aikid, or the -server option to aiki-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> aiki-cli " + methodname + " " + args + "\n";
}
