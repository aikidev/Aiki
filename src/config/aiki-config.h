/* src/config/aiki-config.h.  Generated from aiki-config.h.in by configure.  */
/* src/config/aiki-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Aiki_CONFIG_H

#define Aiki_CONFIG_H
...
#define PACKAGE_BUGREPORT "aiki.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Aiki Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Aiki Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "aiki"
