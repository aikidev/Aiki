...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AIKI address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aiki: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Aiki"), this);
    aboutAction->setStatusTip(tr("Show information about Aiki"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AIKI"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AIKI addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AIKI addresses"));
    ...
    openAction->setStatusTip(tr("Open a AIKI: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Aiki help message to get a list with possible AIKI command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Aiki client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AIKI network", "", count));
}
...
{
    QString strTitle = tr("Aiki"); // default title
