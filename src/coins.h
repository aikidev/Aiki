...
/** 
    ...
    ****Note - for AIKI we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of aiki coming in to a transaction
