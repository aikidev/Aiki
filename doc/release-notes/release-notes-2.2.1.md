Aiki version 2.2.1 is now available from:

  <https://github.com/aikicoin/aiki/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/aikicoin/aiki/issues>

Compatibility
==============

Aiki is extensively tested on multiple operating systems using
...
Aiki should also work on most other Unix-like systems but is not
...
of Bitcoin that AIKI was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/aikicoin-translations/).
