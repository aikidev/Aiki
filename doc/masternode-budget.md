...
Aiki now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<aiki_address\> \<monthly_payment_aiki\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ AIKI, _12_ times over the course of a year totaling _24000_ AIKI.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<aiki_address\> \<monthly_payment_aiki\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` AIKI.
 ...
 * vote-many          - Vote on a Aiki initiative
 * vote-alias         - Vote on a Aiki initiative
 * vote               - Vote on a Aiki initiative/budget
