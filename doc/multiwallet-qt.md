...
In order to support loading of multiple wallets in aiki-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is aiki.cpp.
...
Changes to aiki.cpp
----------------------
aiki.cpp is the entry point into aiki-qt, and as such, will require some minor modifications to provide hooks for
